...
class Contact:
    def __init__(self, firstname=None, middlename=None, nickname=None,
                 ...
                 adress=None, home=None, work=None, mobile=None,
    ...
    def __repr__(self):
        return "%s:%s:%s:%s:%s:%s:%s:%s:%s" % (self.id, self.firstname, self.lastname, self.middlename, self.nickname, self.title,
                             self.company, self.adress, self.home)
