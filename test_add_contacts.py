...
class test_add_contacts(unittest.TestCase):
    ...
    def create_contact(self, wd, firsrname, middlename, nickname, title, lastname, company, adress, home, mobile, work,
                       fax, email, email2, email3, homepage, byear, ayear, adress2, phone2, notes):
        # create new
        ...
        wd.find_element_by_name("firstname").send_keys(firsrname)
    ...
    def test_test_add_contact(self):
        ...
        self.create_contact(wd, firsrname="qqqqqqqq", middlename="wwwwwww", nickname="eeefdeeee", title="vvvvvvvvvv", lastname="eeeeeeeee", company="xccccccccc",
